...
type ResourceViewLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.ResourceView, err error)
...
// List lists all ResourceViews in the indexer.
func (s *resourceViewLister) List(selector labels.Selector) (ret []*v1alpha1.ResourceView, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.ResourceView))
	})
	return ret, err
}
...
type ResourceViewNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.ResourceView, error)
...
// List lists all ResourceViews in the indexer for a given namespace.
func (s resourceViewNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ResourceView, err error) {
...
// Get retrieves the ResourceView from the indexer for a given namespace and name.
func (s resourceViewNamespaceLister) Get(name string) (*v1alpha1.ResourceView, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("resourceview"), name)
	}
	return obj.(*v1alpha1.ResourceView), nil
}

...
type PlacementBindingInterface interface {
	Create(*mcm.PlacementBinding) (*mcm.PlacementBinding, error)
	Update(*mcm.PlacementBinding) (*mcm.PlacementBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*mcm.PlacementBinding, error)
	List(opts v1.ListOptions) (*mcm.PlacementBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *mcm.PlacementBinding, err error)
...
func newPlacementBindings(c *McmClient, namespace string) *placementBindings {
...
func (c *placementBindings) Get(name string, options v1.GetOptions) (result *mcm.PlacementBinding, err error) {
	result = &mcm.PlacementBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *placementBindings) List(opts v1.ListOptions) (result *mcm.PlacementBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &mcm.PlacementBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("placementbindings").
...
func (c *placementBindings) Create(placementBinding *mcm.PlacementBinding) (result *mcm.PlacementBinding, err error) {
	result = &mcm.PlacementBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("placementbindings").
...
func (c *placementBindings) Update(placementBinding *mcm.PlacementBinding) (result *mcm.PlacementBinding, err error) {
	result = &mcm.PlacementBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("placementbindings").
...
func (c *placementBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *mcm.PlacementBinding, err error) {
	result = &mcm.PlacementBinding{}

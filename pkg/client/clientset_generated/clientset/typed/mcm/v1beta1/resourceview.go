...
type ResourceViewInterface interface {
	Create(*v1beta1.ResourceView) (*v1beta1.ResourceView, error)
	Update(*v1beta1.ResourceView) (*v1beta1.ResourceView, error)
	UpdateStatus(*v1beta1.ResourceView) (*v1beta1.ResourceView, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ResourceView, error)
	List(opts v1.ListOptions) (*v1beta1.ResourceViewList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ResourceView, err error)
...
func newResourceViews(c *McmV1beta1Client, namespace string) *resourceViews {
...
func (c *resourceViews) Get(name string, options v1.GetOptions) (result *v1beta1.ResourceView, err error) {
	result = &v1beta1.ResourceView{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *resourceViews) List(opts v1.ListOptions) (result *v1beta1.ResourceViewList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ResourceViewList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("resourceviews").
...
func (c *resourceViews) Create(resourceView *v1beta1.ResourceView) (result *v1beta1.ResourceView, err error) {
	result = &v1beta1.ResourceView{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourceviews").
...
func (c *resourceViews) Update(resourceView *v1beta1.ResourceView) (result *v1beta1.ResourceView, err error) {
	result = &v1beta1.ResourceView{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourceviews").
...
func (c *resourceViews) UpdateStatus(resourceView *v1beta1.ResourceView) (result *v1beta1.ResourceView, err error) {
	result = &v1beta1.ResourceView{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourceviews").
...
func (c *resourceViews) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ResourceView, err error) {
	result = &v1beta1.ResourceView{}

	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.McmV1alpha1().WorkSets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.McmV1alpha1().WorkSets(namespace).Watch(options)
			},
		},
		&mcmv1alpha1.WorkSet{},
		resyncPeriod,
...
func (f *workSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mcmv1alpha1.WorkSet{}, f.defaultInformer)
}

func (f *workSetInformer) Lister() v1alpha1.WorkSetLister {
	return v1alpha1.NewWorkSetLister(f.Informer().GetIndexer())
}

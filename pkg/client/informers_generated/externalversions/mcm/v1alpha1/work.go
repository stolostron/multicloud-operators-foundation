	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.McmV1alpha1().Works(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.McmV1alpha1().Works(namespace).Watch(options)
			},
		},
		&mcmv1alpha1.Work{},
		resyncPeriod,
...
func (f *workInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mcmv1alpha1.Work{}, f.defaultInformer)
}

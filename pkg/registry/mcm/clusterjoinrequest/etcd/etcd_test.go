...
func newStorage(t *testing.T) (*REST, *etcd3testing.EtcdTestServer, *StatusREST) {
	...
	restOptions := generic.RESTOptions{
		...
		ResourcePrefix:          "clusterjoinrequests",
	}
	rest, resstatus := NewREST(restOptions)
	return rest, server, resstatus
}

func validNewClusterJoinRequests() *mcm.ClusterJoinRequest {
	return &mcm.ClusterJoinRequest{
		ObjectMeta: metav1.ObjectMeta{
			Name: "clusterJoinName1",
		},
	}
}
...
func TestRest(t *testing.T) {
	...
	test.TestCreate(
		validNewClusterJoinRequests(),
		&mcm.ClusterJoinRequest{
			ObjectMeta: metav1.ObjectMeta{
				Name: "",
			},
		},
	...
	resstatus.New()
	resstatus.Get(ctx, "clusterJoinName1", &metav1.GetOptions{})
}

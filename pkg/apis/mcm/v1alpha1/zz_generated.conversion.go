...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CLusterJoinRequestConditions)(nil), (*mcm.CLusterJoinRequestConditions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CLusterJoinRequestConditions_To_mcm_CLusterJoinRequestConditions(a.(*CLusterJoinRequestConditions), b.(*mcm.CLusterJoinRequestConditions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.CLusterJoinRequestConditions)(nil), (*CLusterJoinRequestConditions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_CLusterJoinRequestConditions_To_v1alpha1_CLusterJoinRequestConditions(a.(*mcm.CLusterJoinRequestConditions), b.(*CLusterJoinRequestConditions), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ClusterJoinRequestStatus)(nil), (*mcm.ClusterJoinRequestStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus(a.(*ClusterJoinRequestStatus), b.(*mcm.ClusterJoinRequestStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.ClusterJoinRequestStatus)(nil), (*ClusterJoinRequestStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus(a.(*mcm.ClusterJoinRequestStatus), b.(*ClusterJoinRequestStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CLusterJoinRequestConditions_To_mcm_CLusterJoinRequestConditions(in *CLusterJoinRequestConditions, out *mcm.CLusterJoinRequestConditions, s conversion.Scope) error {
	out.Type = mcm.ClusterJoinRequestType(in.Type)
...
// Convert_v1alpha1_CLusterJoinRequestConditions_To_mcm_CLusterJoinRequestConditions is an autogenerated conversion function.
func Convert_v1alpha1_CLusterJoinRequestConditions_To_mcm_CLusterJoinRequestConditions(in *CLusterJoinRequestConditions, out *mcm.CLusterJoinRequestConditions, s conversion.Scope) error {
	return autoConvert_v1alpha1_CLusterJoinRequestConditions_To_mcm_CLusterJoinRequestConditions(in, out, s)
}

func autoConvert_mcm_CLusterJoinRequestConditions_To_v1alpha1_CLusterJoinRequestConditions(in *mcm.CLusterJoinRequestConditions, out *CLusterJoinRequestConditions, s conversion.Scope) error {
	out.Type = ClusterJoinRequestType(in.Type)
	out.Reason = in.Reason
	out.Message = in.Message
	out.LastUpdateTime = in.LastUpdateTime
	return nil
...
// Convert_mcm_CLusterJoinRequestConditions_To_v1alpha1_CLusterJoinRequestConditions is an autogenerated conversion function.
func Convert_mcm_CLusterJoinRequestConditions_To_v1alpha1_CLusterJoinRequestConditions(in *mcm.CLusterJoinRequestConditions, out *CLusterJoinRequestConditions, s conversion.Scope) error {
	return autoConvert_mcm_CLusterJoinRequestConditions_To_v1alpha1_CLusterJoinRequestConditions(in, out, s)
}
...
func autoConvert_v1alpha1_ClusterJoinRequest_To_mcm_ClusterJoinRequest(in *ClusterJoinRequest, out *mcm.ClusterJoinRequest, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_mcm_ClusterJoinRequest_To_v1alpha1_ClusterJoinRequest(in *mcm.ClusterJoinRequest, out *ClusterJoinRequest, s conversion.Scope) error {
	...
	if err := Convert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus(in *ClusterJoinRequestStatus, out *mcm.ClusterJoinRequestStatus, s conversion.Scope) error {
	out.Conditions = *(*[]mcm.CLusterJoinRequestConditions)(unsafe.Pointer(&in.Conditions))
	out.Certificate = *(*[]byte)(unsafe.Pointer(&in.Certificate))
	out.Phase = mcm.ClusterJoinRequestPhase(in.Phase)
	return nil
}

// Convert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus is an autogenerated conversion function.
func Convert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus(in *ClusterJoinRequestStatus, out *mcm.ClusterJoinRequestStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_ClusterJoinRequestStatus_To_mcm_ClusterJoinRequestStatus(in, out, s)
}

func autoConvert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus(in *mcm.ClusterJoinRequestStatus, out *ClusterJoinRequestStatus, s conversion.Scope) error {
	out.Conditions = *(*[]CLusterJoinRequestConditions)(unsafe.Pointer(&in.Conditions))
	out.Certificate = *(*[]byte)(unsafe.Pointer(&in.Certificate))
	out.Phase = ClusterJoinRequestPhase(in.Phase)
	return nil
}

// Convert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus is an autogenerated conversion function.
func Convert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus(in *mcm.ClusterJoinRequestStatus, out *ClusterJoinRequestStatus, s conversion.Scope) error {
	return autoConvert_mcm_ClusterJoinRequestStatus_To_v1alpha1_ClusterJoinRequestStatus(in, out, s)
}
...
func autoConvert_v1alpha1_LeaderVoteSpec_To_mcm_LeaderVoteSpec(in *LeaderVoteSpec, out *mcm.LeaderVoteSpec, s conversion.Scope) error {
	out.Vote = in.Vote
	out.KubernetesAPIEndpoints = in.KubernetesAPIEndpoints

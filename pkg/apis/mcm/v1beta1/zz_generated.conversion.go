...
func autoConvert_v1beta1_WorkSpec_To_mcm_WorkSpec(in *WorkSpec, out *mcm.WorkSpec, s conversion.Scope) error {
	...
	// WARNING: in.WorkSchema requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_mcm_WorkSpec_To_v1beta1_WorkSpec(in *mcm.WorkSpec, out *WorkSpec, s conversion.Scope) error {
	...
	// WARNING: in.Scope requires manual conversion: does not exist in peer-type
	// WARNING: in.ActionType requires manual conversion: does not exist in peer-type
	// WARNING: in.HelmWork requires manual conversion: does not exist in peer-type
	// WARNING: in.KubeWork requires manual conversion: does not exist in peer-type
	return nil
}

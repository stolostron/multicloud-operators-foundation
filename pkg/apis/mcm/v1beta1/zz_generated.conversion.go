...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HelmRelease)(nil), (*mcm.HelmRelease)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_HelmRelease_To_mcm_HelmRelease(a.(*HelmRelease), b.(*mcm.HelmRelease), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.HelmRelease)(nil), (*HelmRelease)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_HelmRelease_To_v1beta1_HelmRelease(a.(*mcm.HelmRelease), b.(*HelmRelease), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HelmReleaseSpec)(nil), (*mcm.HelmReleaseSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec(a.(*HelmReleaseSpec), b.(*mcm.HelmReleaseSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.HelmReleaseSpec)(nil), (*HelmReleaseSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec(a.(*mcm.HelmReleaseSpec), b.(*HelmReleaseSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HelmWorkSpec)(nil), (*mcm.HelmWorkSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_HelmWorkSpec_To_mcm_HelmWorkSpec(a.(*HelmWorkSpec), b.(*mcm.HelmWorkSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.HelmWorkSpec)(nil), (*HelmWorkSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_HelmWorkSpec_To_v1beta1_HelmWorkSpec(a.(*mcm.HelmWorkSpec), b.(*HelmWorkSpec), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ResultHelmList)(nil), (*mcm.ResultHelmList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ResultHelmList_To_mcm_ResultHelmList(a.(*ResultHelmList), b.(*mcm.ResultHelmList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mcm.ResultHelmList)(nil), (*ResultHelmList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mcm_ResultHelmList_To_v1beta1_ResultHelmList(a.(*mcm.ResultHelmList), b.(*ResultHelmList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_HelmRelease_To_mcm_HelmRelease(in *HelmRelease, out *mcm.HelmRelease, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta1_HelmRelease_To_mcm_HelmRelease is an autogenerated conversion function.
func Convert_v1beta1_HelmRelease_To_mcm_HelmRelease(in *HelmRelease, out *mcm.HelmRelease, s conversion.Scope) error {
	return autoConvert_v1beta1_HelmRelease_To_mcm_HelmRelease(in, out, s)
}

func autoConvert_mcm_HelmRelease_To_v1beta1_HelmRelease(in *mcm.HelmRelease, out *HelmRelease, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_mcm_HelmRelease_To_v1beta1_HelmRelease is an autogenerated conversion function.
func Convert_mcm_HelmRelease_To_v1beta1_HelmRelease(in *mcm.HelmRelease, out *HelmRelease, s conversion.Scope) error {
	return autoConvert_mcm_HelmRelease_To_v1beta1_HelmRelease(in, out, s)
}

func autoConvert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec(in *HelmReleaseSpec, out *mcm.HelmReleaseSpec, s conversion.Scope) error {
...
// Convert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec is an autogenerated conversion function.
func Convert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec(in *HelmReleaseSpec, out *mcm.HelmReleaseSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_HelmReleaseSpec_To_mcm_HelmReleaseSpec(in, out, s)
}

func autoConvert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec(in *mcm.HelmReleaseSpec, out *HelmReleaseSpec, s conversion.Scope) error {
	out.ReleaseName = in.ReleaseName
	out.Description = in.Description
	out.FirstDeployed = in.FirstDeployed
	out.LastDeployed = in.LastDeployed
...
// Convert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec is an autogenerated conversion function.
func Convert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec(in *mcm.HelmReleaseSpec, out *HelmReleaseSpec, s conversion.Scope) error {
	return autoConvert_mcm_HelmReleaseSpec_To_v1beta1_HelmReleaseSpec(in, out, s)
}

func autoConvert_v1beta1_HelmWorkSpec_To_mcm_HelmWorkSpec(in *HelmWorkSpec, out *mcm.HelmWorkSpec, s conversion.Scope) error {
	out.ReleaseName = in.ReleaseName
...
// Convert_v1beta1_HelmWorkSpec_To_mcm_HelmWorkSpec is an autogenerated conversion function.
func Convert_v1beta1_HelmWorkSpec_To_mcm_HelmWorkSpec(in *HelmWorkSpec, out *mcm.HelmWorkSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_HelmWorkSpec_To_mcm_HelmWorkSpec(in, out, s)
}

func autoConvert_mcm_HelmWorkSpec_To_v1beta1_HelmWorkSpec(in *mcm.HelmWorkSpec, out *HelmWorkSpec, s conversion.Scope) error {
	out.ReleaseName = in.ReleaseName
	out.InSecureSkipVerify = in.InSecureSkipVerify
	out.ChartName = in.ChartName
	out.Version = in.Version
...
// Convert_mcm_HelmWorkSpec_To_v1beta1_HelmWorkSpec is an autogenerated conversion function.
func Convert_mcm_HelmWorkSpec_To_v1beta1_HelmWorkSpec(in *mcm.HelmWorkSpec, out *HelmWorkSpec, s conversion.Scope) error {
	return autoConvert_mcm_HelmWorkSpec_To_v1beta1_HelmWorkSpec(in, out, s)
}
...
func autoConvert_v1beta1_ResultHelmList_To_mcm_ResultHelmList(in *ResultHelmList, out *mcm.ResultHelmList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]mcm.HelmRelease)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1beta1_ResultHelmList_To_mcm_ResultHelmList is an autogenerated conversion function.
func Convert_v1beta1_ResultHelmList_To_mcm_ResultHelmList(in *ResultHelmList, out *mcm.ResultHelmList, s conversion.Scope) error {
	return autoConvert_v1beta1_ResultHelmList_To_mcm_ResultHelmList(in, out, s)
}

func autoConvert_mcm_ResultHelmList_To_v1beta1_ResultHelmList(in *mcm.ResultHelmList, out *ResultHelmList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]HelmRelease)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_mcm_ResultHelmList_To_v1beta1_ResultHelmList is an autogenerated conversion function.
func Convert_mcm_ResultHelmList_To_v1beta1_ResultHelmList(in *mcm.ResultHelmList, out *ResultHelmList, s conversion.Scope) error {
	return autoConvert_mcm_ResultHelmList_To_v1beta1_ResultHelmList(in, out, s)
}
...
// Convert_mcm_WorkSpec_To_v1beta1_WorkSpec is an autogenerated conversion function.
func Convert_mcm_WorkSpec_To_v1beta1_WorkSpec(in *mcm.WorkSpec, out *WorkSpec, s conversion.Scope) error {
	return autoConvert_mcm_WorkSpec_To_v1beta1_WorkSpec(in, out, s)
}

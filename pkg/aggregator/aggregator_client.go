...
// InfoGetter is getter to aggregated information getter
...
// NewGetter returns a new aggregator connection info getter
func NewGetter(client kubeclientset.Interface) *InfoGetter {
	return &InfoGetter{
...
func (a *InfoGetter) AddAndUpdate(o *Options) {
	a.mutex.Lock()
...
func (a *InfoGetter) Delete(name string) {
	a.mutex.Lock()
	defer a.mutex.Unlock()
...
func (a *InfoGetter) Get(subResource string) (*ConnectionInfoGetter, bool) {
	a.mutex.RLock()
...
func NewConnectionInfoGetter(o *Options, client kubeclientset.Interface) *ConnectionInfoGetter {

...
const (
	// KlusterletDeployModeAnnotation is the annotation key of klusterlet deploy mode, it describes the
	...
	// AnnotationKlusterletHostingClusterName is is the annotation key of hosting cluster name for klusterlet,

...
func (r *clusterClaimReconciler) SetupWithManager(mgr ctrl.Manager,
	clusterInformer clusterv1alpha1informer.ClusterClaimInformer) error {
	...
	if err := c.Watch(&source.Kind{Type: &clusterv1beta1.ManagedClusterInfo{}},
...
func (s *clusterClaimSource) Start(ctx context.Context,
	handler handler.EventHandler,
	queue workqueue.RateLimitingInterface,
	predicates ...predicate.Predicate) error {
	// all predicates are ignored
	_, err := s.claimInformer.AddEventHandler(cache.ResourceEventHandlerFuncs{

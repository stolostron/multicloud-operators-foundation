...
replace (
	...
	github.com/openshift/hive/apis => github.com/openshift/hive/apis v0.0.0-20220815220535-60b8a9aace22
...
require (
	...
	github.com/openshift/hive v1.1.9-1.1.8.2.0.20220815220535-60b8a9aace22

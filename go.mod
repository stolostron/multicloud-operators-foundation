...
require (
	...
	github.com/metal3-io/baremetal-operator v0.0.0-20200228072510-dfd5fea95b0a // indirect
	...
	github.com/openshift/hive v0.0.0-20200302220132-867d7fb189bf // indirect

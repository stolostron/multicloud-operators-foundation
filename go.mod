...
replace github.com/openshift/hive/apis => github.com/openshift/hive/apis v0.0.0-20230825202726-4418e43e27a3
...
require (
	...
	github.com/stolostron/cluster-lifecycle-api v0.0.0-20230815014244-5cd49f3b660c

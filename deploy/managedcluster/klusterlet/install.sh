...
REGISTRATION_OPERATOR_BRANCH=${REGISTRATION_OPERATOR_BRANCH:-release-2.2}
...
make hub-kubeconfig GO_REQUIRED_MIN_VERSION:=
make cluster-ip GO_REQUIRED_MIN_VERSION:=

...
OCM_BRANCH=${OCM_BRANCH:-backplane-2.7}
...
../$HELM install \
	...
	--set global.imageOverrides.cluster_proxy_addon="${CLUSTER_PROXY_ADDON_IMAGE}:backplane-2.7" \
	--set global.imageOverrides.cluster_proxy="${IMAGE_CLUSTER_PROXY}:backplane-2.7" \
